...
MP3_FOLDER = os.getenv("AB_MP3_FOLDER", None)
GOOGLE_HOME_IP = os.getenv("AB_GOOGLE_HOME_IP", "192.168.1.50")  # replace with your device IP

print(f"Environemnt variables: ENV={ENV}, PORT_SERVER={PORT_SERVER}, IP_SERVER={IP_SERVER}, MP3_FOLDER={MP3_FOLDER}, GOOGLE_HOME_IP={GOOGLE_HOME_IP}")
